...
def main() -> None:
    ...
    print("[1/5] Scene analysis ->", scene_path)
    ...
    print("[4/5] Building SparkJS runtime config")
    ...
    print("[5/5] Rendering frames with Playwright + SparkJS")
    render_cmd = [
        args.node_bin,
        "renderer/render.js",
        "--config",
